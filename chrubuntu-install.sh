...
echo \"deb http://cn.archive.ubuntu.com/ubuntu/ $ubuntu_version main universe multiverse restricted
deb http://cn.archive.ubuntu.com/ubuntu/ $ubuntu_version-updates main universe multiverse restricted
deb http://cn.archive.ubuntu.com/ubuntu/ $ubuntu_version-security main universe multiverse restricted\" > /etc/apt/sources.list
apt-get -y update
apt-get -y upgrade
